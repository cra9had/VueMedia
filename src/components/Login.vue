<template>
  <div class="wrapper fadeInDown">
    <div id="formContent">
      <input type="text" id="email" class="fadeIn first" placeholder="Email">
      <input type="password" id="password" class="fadeIn second" placeholder="Password">
...
export default {
  ...
  methods: {
    ...
    async Login () {
      ...
      const response = await fetch(this.$api_host + 'account/login', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
